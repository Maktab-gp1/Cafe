...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/Maktab-gp1/Cafe.git
   ```
...
- **Update Orders:** Add, edit, or remove items from the order.
- **Update Menu:** Add, edit, or remove items from the menu and categories.
